...
const SECTIONS = [
  {
    ...
    path: "/artifacts",
    desc: "Browse alien artifacts",
  },
  {
    icon: "📅",
    title: "Timeline",
    path: "/timeline",
    desc: "Civilization history",
  },
        ...
        {bestRank && (
          <div
            style={{
              ...
              marginBottom: "32px",
              textAlign: "center",
              borderColor: RANK_CONFIG[bestRank].color + "44",
            }}
          >
            <p
              style={{
            ...
            <div
              style={{
                ...
                padding: "10px 24px",
                borderRadius: "8px",
                background: RANK_CONFIG[bestRank].color + "15",
                border: `1px solid ${RANK_CONFIG[bestRank].color}44`,
              }}
            >
              <span
                style={{ fontSize: "22px", color: RANK_CONFIG[bestRank].color }}
              >
              ...
              <span
                style={{
                  ...
                  fontSize: "18px",
                  fontWeight: 700,
                  color: RANK_CONFIG[bestRank].color,
                }}
              >
                {bestRank}
              </span>
