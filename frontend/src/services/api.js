...
export const artifactAPI = {
  ...
  create:  (data)      => api.post('/artifacts', data, { headers: { 'Content-Type': 'multipart/form-data' } }),
  update:  (id, data)  => api.put(`/artifacts/${id}`, data, { headers: { 'Content-Type': 'multipart/form-data' } }),
